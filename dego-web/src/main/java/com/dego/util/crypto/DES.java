...
public abstract class DES {
     ...
     * @return 16进制的字符串密文
     */
    public final static String encryptToHex(String src, String key) throws Exception {
     ...
     */
    public final static String encryptToBase64(String src, String key) throws Exception {
     ...
     */
    public final static String encryptToBase64Url(String src, String key) throws Exception {
        byte[] desBytes = encrypt(src.getBytes(), key.getBytes());
        byte[] base64Bytes = Base64.encodeBase64(desBytes);
     ...
     * @return 字符串原文
     */
    public final static String decryptFromHex(String src, String key) throws Exception {
     ...
     * @return 字符串原文
     */
    public final static String decryptFromBase64(String src, String key) throws Exception {
    ...
    public static byte[] hexToByte(byte[] hexBytes) {
        if ((hexBytes.length % 2) != 0) {
            throw new BusinessException("16进制转二进制失败");
        }
